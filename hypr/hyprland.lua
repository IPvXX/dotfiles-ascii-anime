...
local terminal2   = "ghostty +new-window"
local fileManager = "QT_QPA_PLATFORMTHEME=qt6ct dolphin"
local menu        = "pgrep wofi >/dev/null 2>&1 && killall wofi || wofi --show drun --location=top -y 15"
...
-- Workspace spring (slower + bouncy)
...
hl.animation({ leaf = "windows",       enabled = true,  speed = 3.8, spring = "easy" })
...
-- Slower, springy workspace slide
hl.animation({ leaf = "workspaces",    enabled = true, speed = 1.4, spring = "workspaceSpring", style = "slide" })
hl.animation({ leaf = "workspacesIn",  enabled = true, speed = 1.5, spring = "workspaceSpring", style = "slide" })
hl.animation({ leaf = "workspacesOut", enabled = true, speed = 1.5, spring = "workspaceSpring", style = "slide" })
...
hl.bind(mainMod .. " + SHIFT + B",
    hl.dsp.exec_cmd("~/.config/hypr/scripts/firefox-opacity-toggle.sh"))
hl.bind(mainMod .. " + W", hl.dsp.exec_cmd(wallpaper))
hl.bind(mainMod .. " + Home", hl.dsp.exec_cmd(screenshot))
